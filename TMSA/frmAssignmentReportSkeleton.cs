...
namespace TMSA
{
    public partial class frmAssignmentsReportSkeleton : Form
    {
        public frmAssignmentsReportSkeleton()
        {
            InitializeComponent();
        ...
        private void frmAssignmentsReportSkeleton_FormClosed(object sender, FormClosedEventArgs e)
        {
            Singleton.assignmentsreportskeleton = null;
        }
